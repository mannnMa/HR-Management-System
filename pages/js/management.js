...
function addInputRow() {
  ...
  row.innerHTML = `
    ...
    <td><input class="contact-input" type="text" placeholder="Contact" maxlength="11"></td>
    <td>
    <div class="action-row-buttons">
      <button class="action-button save-button">Save</button>
      <button class="cancel-add-button">
        <img src="/HR-Management-System/assets/cancel-icon.webp" alt="cancel">
      </button> 
    </div>
    </td>
  `;
    ...
    <td class="action-cell">
      <div class="action-row-buttons">
        <button class="edit-button">
          <img class="edit-icon" src="/HR-Management-System/assets/edit-icon.webp" alt="Edit">  
        </button>
        <button class="delete-button">
          <img class="delete-icon" src="/HR-Management-System/assets/delete-icon.webp" alt="Delete">
        </button>
      </div>
    </td>
  `;
  ...
  function handleSave() {
    ...
    if (updatedValues.some(v => v === '')) {
      showPrompt('Please fill in all fields.', () => {
        ...
        editBtn.innerHTML = `<img class="edit-icon" src="/HR-Management-System/assets/edit-icon.webp" alt="Edit">`;
...
function showPrompt(message, onConfirm, onCancel, type = 'default') {
  ...
  //animation icons
  if (type === 'delete') {
    animationHTML = `<video class="trash-bin-vid" src="/HR-Management-System/assets/animation/trash-bin.mp4" autoplay muted loop></video>`;
  } else if (type === 'save') {
    animationHTML = `<video class="save-check-vid" src="/HR-Management-System/assets/animation/missing-fill.mp4" autoplay muted loop></video>`;
  } else if (type === 'newEmployee') {
    animationHTML = `<video class="new-employee-vid" src="/HR-Management-System/assets/animation/employee.mp4" autoplay muted loop></video>`;
  } else {
