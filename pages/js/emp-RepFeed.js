...
if (reportForm) {
    reportForm.addEventListener('submit', (e) => {
        ...
        // minimum description length validation to 8 characters
...
// Render files with remove buttons
    ...
    removeButtons.forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            if (!isNaN(index)) {
                ...
                renderFileList(); // re-render to refresh index bindings
            }
        });
    });
}
...
if (leaveForm) {
    leaveForm.addEventListener('submit', (e) => {
        ...
        setTimeout(() => {
            ...
            hideAllForms(); // assuming this is defined elsewhere
        }, 3000);
    });
}
